	...
	<div id="main">
		<div class="content">
			<div class="comDetailBox">
				<div class="ttlBox">
					<p class="title">自社製品のシングルモードファイバパッチコードに新作が登場しました！</p>
					<p class="date">2021.00.00<span class="tag">オプトロンニュース</span></p>
				</div>
				<div class="photo"><img src="<?php bloginfo('template_url');?>/img/news/photo01.jpg" alt=""></div>
				<h2>(H2)シングルモードファイバパッチコード</h2>
				<p>サンプルテキストです。現在タブ切り替えにしている部分などは畳まずに記載した方がユーザーの閲覧がしやすいため、このフォーマットを使用します。吾輩は猫である。名前はまだ無い。どこで生れたかとんと見当がつかぬ。何でも薄暗いじめじめした所でニャーニャー泣いていた事だけは記憶している。吾輩はここで始めて人間というものを見た。しかもあとで聞くとそれは書生という人間中で一番獰悪な種族であったそうだ。この書生というのは時々我々を捕えて煮て食うという話である。しかしその当時は何という考もなかったから別段恐しいとも思わなかった。ただ彼の掌に載せられてスーと持ち上げられた時何だかフワフワした感じがあったばかりである。掌の上で少し落ちついて書生の顔を見たのがいわゆる人間というものの見始であろう。この時妙なものだと思った感じが今でも残っている。第一毛をもって装飾されべきはずの顔がつるつるしてまるで薬缶だ。その後猫にもだいぶ逢ったがこんな片輪には一度も出会わした事がない。のみならず顔の真中があまりに突起している。そうしてその穴の中から時々ぷうぷうと煙を</p>
			</div>
...
<ul id="pagePath">
	...
	<li>自社製品のシングルモードファイバパッチコードに新作が登場しました！</li>
</ul>
<?php get_footer(); ?>
